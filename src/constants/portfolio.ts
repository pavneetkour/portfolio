...
export const PROJECTS: Project[] = [
  {
    ...
    caseStudy: {
      ...
      problem:
        "Users needed reliable, low-latency chat with media support and push-driven re-engagement.",
      solution:
  ...
  },
  {
    ...
    emoji: "🛒",
    description:
      "Self-service shopping with QR scanning, in-app payments, and local product discovery.",
    highlights: [
  ...
  },
  {
    ...
    emoji: "📦",
    description:
      "On-demand delivery with request management, in-app chat, secure payments, and tipping.",
    highlights: [
